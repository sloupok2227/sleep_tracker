...
SECRET_KEY = 'django-insecure-52=&34*11nd3^it6gv-&q)xq^6#4w0bhsv2fa9gzfm&ycjv=a='
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',  # Должно быть только здесь
    'sleep',  # Ваше приложение
]
...
LOGIN_URL = '/login/'  # Путь для входа
